 ...
 * in your angular manage (use {@link ui.router} module instead).
 *
 */
 ...
 * as a dependency within your angular manage. The other modules are for organization purposes.
 *
 * The modules are:
 * * ui.router - the main "umbrella" module
 * * ui.router.router - 
 * 
 * *You'll need to include **only** this module as the dependency within your angular manage.*
 * 
 * <pre>
 * <!doctype html>
 * <html ng-manage="myApp">
 * <head>
...
function $UrlRouterProvider(   $locationProvider,   $urlMatcherFactory) {
   ...
   * @example
   * <pre>
   * var manage = angular.module('manage', ['ui.router.router']);
   *
   * manage.config(function ($urlRouterProvider) {
 ...
 * nested states.
 *
 * The `$stateProvider` provides interfaces to declare these states for your manage.
 */
...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
  ...
  function $get(   $rootScope,   $q,   $view,   $injector,   $resolve,   $stateParams,   $urlRouter) {
     ...
     * @example
     * <pre>
     * var manage angular.module('manage', ['ui.router']);
     *
     * manage.controller('ctrl', function ($scope, $state) {
 ...
 *     <a href ui-sref="manage.user({user: 'bilbobaggins'})">@bilbobaggins</a>
 *   </li>
 * </ul>
 * </pre>
 *
 *
 * When the manage state is "manage.user" (or any children states), and contains the state parameter "user" with value "bilbobaggins",
 * the resulting HTML will appear as (note the 'active' class):
 * <pre>
 * <ul>
 *   <li ui-sref-active="active" class="item active">
 *     <a ui-sref="manage.user({user: 'bilbobaggins'})" href="/users/bilbobaggins">@bilbobaggins</a>
 *   </li>
 * </ul>
 * </pre>
 *
